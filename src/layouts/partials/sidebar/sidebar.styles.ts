...
export const SidebarWrapper = tv({
  base: "bg-background transition-transform h-full fixed -translate-x-full w-64 shrink-0 z-[202] overflow-y-auto border-r border-divider flex-col md:ml-0 md:flex md:static md:h-screen md:translate-x-0",
...
export const Body = tv({
  base: "flex flex-col gap-0.5 mt-4",
});
